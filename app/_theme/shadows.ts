...
// let createCustomShadow = createCustomShadow(LIGHT_MODE)
// let createShadow = createShadow(DARK_MODE)
export type TypeOfShadow = ReturnType<typeof createCustomShadow >
export type TypeOfCreateShadow = ReturnType<typeof createShadow >
